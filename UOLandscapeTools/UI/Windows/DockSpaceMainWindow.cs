...
{
    public sealed class DockSpaceMainWindow : Window, IDockSpaceMainWindow
    {
        ...
        public override bool Show(uint dockSpaceId)
        {
            ...
            if (_optFullscreen)
            {
                ...
                ImGui.SetNextWindowPos(new Num.Vector2(200, viewport.WorkPos.Y));
                //ImGui.SetNextWindowSize(viewport.WorkSize);
                ImGui.SetNextWindowSize(new Num.Vector2(viewport.WorkSize.X -200, viewport.WorkSize.Y));
            ...
            ImGui.Begin("DockSpaceMain", ref _isVisible, windowFlags);
            if (!_optPadding)
            {
                ImGui.PopStyleVar();
            }
